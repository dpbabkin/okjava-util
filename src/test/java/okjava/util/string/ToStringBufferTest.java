...
public class ToStringBufferTest {
    ...
    public void testRuntimeException() {
        ...
        assertThat(result, matchesPattern("test \\{ RuntimeException=java\\.lang\\.RuntimeException \\{ message=msg0 thread=[A-z ]+ \\} \\}"));
    }
    ...
    public void testRuntimeExceptionNoMessage() {
        ...
        assertThat(result, matchesPattern("test \\{ RuntimeException=java\\.lang\\.RuntimeException \\{ thread=[A-z ]+ \\} \\}"));
    }

    @Test
    public void testIllegalArgumentException() {
        String result = ToStringBuffer.string("test").addThrowable(new IllegalArgumentException("msg1")).toString();
        assertThat(result, matchesPattern("test \\{ RuntimeException=java\\.lang\\.IllegalArgumentException \\{ message=msg1 thread=[A-z ]+ \\} \\}"));
    }

    @Test
    public void testError() {
        String result = ToStringBuffer.string("test").addThrowable(new Error("msg2")).toString();
        assertThat(result, matchesPattern("test \\{ Error=java\\.lang\\.Error \\{ message=msg2 thread=[A-z ]+ \\} \\}"));
    }

    @Test
    public void testAssertionError() {
        String result = ToStringBuffer.string("test").addThrowable(new AssertionError("msg3")).toString();
        assertThat(result, matchesPattern("test \\{ Error=java\\.lang\\.AssertionError \\{ message=msg3 thread=[A-z ]+ \\} \\}"));
    }

    @Test
    public void testException() {
        String result = ToStringBuffer.string("test").addThrowable(new Exception("msg4")).toString();
        assertThat(result, matchesPattern("test \\{ Exception=java\\.lang\\.Exception \\{ message=msg4 thread=[A-z ]+ \\} \\}"));
    }

    @Test
    public void testIOException() {
        String result = ToStringBuffer.string("test").addThrowable(new IOException("msg5")).toString();
        assertThat(result, matchesPattern("test \\{ Exception=java\\.io\\.IOException \\{ message=msg5 thread=[A-z ]+ \\} \\}"));
    }
    ...
    public void testThrowable() {
        ...
        //assertThat(result, matchesPattern("test \\{ Throwable=java\\.lang\\.Throwable \\{ message=msg6 thread=[A-z ]+ \\} \\}"));
    }
    ...
    public void testNoneThrowable() {
        ...
        //assertThat(result, matchesPattern("test \\{ Throwable=okjava\\.util\\.string\\.ToStringBufferTest\\$NoneThrowable \\{ message=msg7 thread=[A-z ]+ \\} \\}"));
    }
