...
final class TimeSequenceIdGeneratorDeprecated implements IdGenerator<TimeSequenceId> {

    private static IdGenerator<TimeSequenceId> INSTANCE = new TimeSequenceIdGeneratorDeprecated();
    private final IdGenerator<Long> idGenerator = AtomicIdGenerator.atomicIdGenerator();

    private TimeSequenceIdGeneratorDeprecated() {
